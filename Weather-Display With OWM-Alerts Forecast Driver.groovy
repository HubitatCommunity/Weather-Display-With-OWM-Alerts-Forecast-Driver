...
// >>>>>>>>>> End Process Only If feelsLike from WD Is NOT Selected  <<<<<<<<<<
		if(alertPublish) {
			...
			String alertTile = (myGetData('alert')== 'No current weather alerts for this area' ? 'No Weather Alerts for ' : 'Weather Alert for ') + myGetData('city') + (myGetData('alertSender')==sSPC ? '' : ' issued by ' + myGetData('alertSender')) + ' updated at ' + myGetData(sSUMLST) + ' on ' + myGetData('Summary_last_poll_date') + '.<br>'
...
@Field final Map attributesMap = [
	'threedayTile':				[t: 'Three Day Forecast Tile', d: 'Display Three Day Forecast Tile?', ty: false, defa: sFLS],
	...
	'country':					[t: 'Country', d: 'Display \'country\'?', ty: sSTR, defa: sFLS],
	...
	'moonPhase':				[t: 'Moon Phase', d: 'Display \'moonPhase\'?', ty: sSTR, defa: sFLS],
	'solarradiation':			[t: 'Solar Radiation', d: 'Display \'solarradiation\'?', ty: sSTR, defa: sFLS],
	'raintoday':				[t: 'Precipitation today (in default unit)', d: 'Display precipitation today?', ty: sNUM, defa: sFLS],
	...
	'state':					[t: 'State', d: 'Display \'state\'?', ty: sSTR, defa: sFLS],
	...
	'wind_direction':			[t: 'Wind direction', d: 'Display the Wind Direction?', ty: sSTR, defa: sFLS],
